...
const projectTypes = [
  ...
  },
  {
    ...
    description:
      "Instalación solar para viviendas grandes o multifamiliares (10-50 kW)",
    color: "#F7B32B",
  ...
  },
  {
    name: "Comercial",
    description:
      "Instalación solar para edificios comerciales y oficinas (50-250 kW)",
    color: "#15B869",
  ...
  },
  {
    name: "Industrial",
    description:
      "Instalación solar para plantas industriales y almacenes (250+ kW)",
    color: "#2E86AB",

      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-amber-50 p-4">
        <Card className="w-full max-w-md shadow-apple-lg">
          <CardHeader className="text-center">
            <div className="mx-auto w-16 h-16 bg-green-50 dark:bg-green-900/200 rounded-full flex items-center justify-center mb-4">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 rounded-lg p-4 text-sm text-green-800 text-center">
